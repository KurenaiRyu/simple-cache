...
public class RecordNamingStrategyPatchModule extends SimpleModule {
    ...
    private static class ValueInstantiatorsModifier extends ValueInstantiators.Base {
        ...
        public ValueInstantiator findValueInstantiator(
            ...
            Map<String, BeanPropertyDefinition> map = beanDesc.findProperties().stream().collect(Collectors.toMap(BeanPropertyDefinition::getInternalName, Function.identity()));
