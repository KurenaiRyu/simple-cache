...
//
//  @Override
//  public <T> void put(Map<String, T> keyValueMap) {
...
//
//  @Override
//  public <T> void put(String namespace, Map<String, T> keyValueMap) {
//    Map<String, Object> params = new HashMap<>();
...
//  }
//
//  public <T> Boolean putIfAbsent(Map<String, T> keyValueMap) {
//    Map<String, Object> params = new HashMap<>();
//    keyValueMap.forEach((k ,v) -> params.put(buildCacheKey(k, v.getClass().getName()), v));
...
//
//  @Override
//  public <T> Boolean putIfAbsent(String namespace, Map<String, T> keyValueMap) {
//    Map<String, Object> params = new HashMap<>();
//    keyValueMap.forEach((k ,v) -> params.put(buildCacheKey(k, namespace), v));
//    return commands.msetnx(params);
//  }
//
//  @Override
//  public <T> Boolean putIfAbsent(String namespace, Map<String, T> keyValueMap, long ttl) {
//    Map<String, Object> params = new HashMap<>();
...
//
//  @Override
//  public Boolean multiRemove(String namespace, Collection<String> keys) {
...
//
//  @Override
//  public RedisClusterCommands<String, Object> getExec() {
//    return commands;
//  }
//}
